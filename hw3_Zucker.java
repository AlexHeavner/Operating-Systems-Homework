...
public class hw3_Zucker 
{
	...
	{
		FileWriter fw = new FileWriter("hw3.txt");
		...
		final int MAX_RESOURCES_AVAILABLE = 1; 
		Semaphore semaphore = new Semaphore(MAX_RESOURCES_AVAILABLE);
		...
		while(!(priority_queue.size() == 0 && waiting_queue.size() == 0 && ready_queue.size() == 0))
		{
			...
			else 
			{
				...
				else
				{
					...
					else 
					{
						...
						//If the process is out of time get a new process
			...
			if(running_process != null)
				fw.write("The Processor is running process: " + running_process + "\n");
		}
